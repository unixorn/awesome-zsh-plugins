...
* [emacs](https://github.com/cowboyd/zsh-emacs) - Handy aliases for Emacs as well as make Emacs the default editor for CLI operations like editting git commit messages.
