...
- [kubectl-plugin](https://github.com/MartinSimango/kubectl-plugin-autocompletion) - `kubectl` completion scripts that extend the `kubectl` auto complete functionality in order to accomodate for plugin sub-commands.
