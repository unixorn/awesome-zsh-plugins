...
- [toolbox](https://github.com/paxcoder/zsh-toolbox) - Automagically updates [homebrew](https://brew.sh) plugins.
...
- [gcloud (wintermi)](https://github.com/wintermi/zsh-gcloud) - Adds Google Cloud Command Line Interface (gcloud CLI) completions.
...
- [aguiar](https://github.com/aguiar-us/aguiar.zsh-theme) - Includes decorators for user@hostname and current working directory.
