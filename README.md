...
* [splunk.plugin.zsh ![GitHub stars](https://img.shields.io/github/stars/noisufnoc/splunk.plugin.zsh.svg)](https://github.com/noisufnoc/splunk.plugin.zsh) - Environment-aware plugin for splunk
