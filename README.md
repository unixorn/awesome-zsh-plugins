...
### [zplugin ![GitHub stars](https://img.shields.io/github/stars/psprint/zplugin.svg)](https://github.com/psprint/zplugin)

**Zplugin** gives reports from plugin load. Plugins are no longer black boxes, report will tell what aliases, functions, bindkeys, Zle widgets, zstyles, completions, variables, PATH and FPATH elements a plugin has set up. Supported is **unloading** of plugin and ability to list, uninstall, reinstall and selectively disable, enable plugin's completions. Also, every plugin is compiled and user can control this function. The system does not use $FPATH, it's kept clean!
...
* [calc.plugin.zsh ![GitHub stars](https://img.shields.io/github/stars/arzzen/calc.plugin.zsh.svg)](https://github.com/arzzen/calc.plugin.zsh) - calculator for zsh
...
* [git-add-remote ![GitHub stars](https://img.shields.io/github/stars/caarlos0/git-add-remote.svg)](https://github.com/caarlos0/git-add-remote) - Easily add the upstream remote to your git fork.
...
* [solarized-man ![GitHub stars](https://img.shields.io/github/stars/zlsun/solarized-man.svg)](https://github.com/zlsun/solarized-man) - A modified version of oh-my-zsh's plugin colored-man-pages, optimized for solarized dark theme in terminal
* [statify ![GitHub stars](https://img.shields.io/github/stars/vladmrnv/statify.svg)](https://github.com/vladmrnv/statify) - Plugin that does basic statistical analysis
...
* [zsh-maven-plugin ![GitHub stars](https://img.shields.io/github/stars/KyleChamberlin/zsh_maven_plugin.svg)](https://github.com/KyleChamberlin/zsh_maven_plugin) - fork of the oh-my-zsh maven plugin
...
* [zsh-travis ![GitHub stars](https://img.shields.io/github/stars/denolfe/zsh-travis.svg)](https://github.com/denolfe/zsh-travis) - Open's Travis CI page for the current repo if one exists.
...
* [darkblood](https://github.com/BinaryMuse/oh-my-zsh/blob/binarymuse/themes/darkblood.zsh-theme) - Original darkblood theme.
* [docker-compose ![GitHub stars](https://img.shields.io/github/stars/sroze/docker-compose-zsh-plugin.svg)](https://github.com/sroze/docker-compose-zsh-plugin) Show docker container status in your prompt.
...
* [frlo ![GitHub stars](https://img.shields.io/github/stars/fiorillo/frlo.svg)](https://github.com/fiorillo/frlo) - Uses your computer's hostname to come up with a (hopefully) unique three-color theme to display in your prompt, so you know at a glance which machine you're logged into.
...
* [spaceship ![GitHub stars](https://img.shields.io/github/stars/denysdovhan/spaceship-zsh-theme.svg)](https://github.com/denysdovhan/spaceship-zsh-theme) - A zsh theme with git, nvm, rvm/rbenv/chruby, python, ssh and other useful indicators.
...
* [sugarfree ![GitHub stars](https://img.shields.io/github/stars/cbrock/sugar-free.svg)](https://github.com/cbrock/sugar-free) - Based on the [Pure](https://github.com/sindresorhus/pure) and [Candy](https://github.com/BinaryMuse/oh-my-zsh/blob/binarymuse/themes/candy.zsh-theme) themes.
