...
* [buidler](https://github.com/gonzalobellino/buidler-zsh) - Adds completion and useful aliases for NomicLabs Buidler tool [buidler.dev](https://github.com/gonzalobellino/buidler-zsh/blob/master/buidler.dev).
