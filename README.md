...
* [zsh-nodejs-plugin](https://github.com/srijanshetty/node.plugin.zsh) - nodejs plugin for zsh with caching of nvm completions and
autoloading of nvm if present.
